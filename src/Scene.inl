...
void Scene::init(void)
{
    ...
    material["red"]->diffuse = vec4(0.65f, 0.05f, 0.05f, 1.0f);
    material["red"]->specular = vec4(0.65f, 0.05f, 0.05f, 1.0f);
    ...
    material["white"]->specular = vec4(0.725f, 0.71f, 0.68f, 1.0f);
    material["white"]->shininess = 100.0f;

    material["green"] = new Material;
    material["green"]->ambient = vec4(0.1f, 0.1f, 0.1f, 1.0f);
    material["green"]->diffuse = vec4(0.12f, 0.45f, 0.15f, 1.0f);
    material["green"]->specular = vec4(0.12f, 0.45f, 0.15f, 1.0f);
